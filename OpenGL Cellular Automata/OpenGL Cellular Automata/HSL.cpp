...
color_t HSL::TurnToRGB()
{
    ...
    else
    {
        ...
        float r = (255 * HueToRGB(arg1, arg2, (H + 1.0 / 3.0)));
        float g = (255 * HueToRGB(arg1, arg2, H));
        float b = (255 * HueToRGB(arg1, arg2, (H - 1.0 / 3.0)));
